  ...
  return (
    ...
    <div className="controls-panel">
      ...
      <div className="contols-panel-card">
        <img src="/image/login-page/setting/2.png" alt="" className="contols-panel-card-img"/>
        <p className="contols-panel-card-text">Add Meeting</p>
      </div>
      <div className="contols-panel-card">
        <img src="/image/login-page/setting/3.png" alt="" className="contols-panel-card-img"/>
        <p className="contols-panel-card-text">Add Task</p>
      </div>
      <div className="contols-panel-card">
